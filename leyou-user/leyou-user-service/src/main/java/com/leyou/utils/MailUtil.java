...
public class MailUtil {
    ...
    public static final String myEmailAccount = "heyinnnn1@163.com";
    public static final String myEmailPassword = "FZGDKEQHCXFKUYQU";
...
//     public static final String receiveMailAccount = "";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String body)
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "小管理", "UTF-8"));
